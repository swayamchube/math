...
\input{sections/valuation-rings.tex}

\section{Discrete Valuation Rings and Dedekind Domains}
\input{sections/dvr-dedekind.tex}

\section{Dimension Theory}
\input{sections/dimension-theory.tex}

\part{Homological Methods}

\section{Regular Sequences}
\input{sections/regular-sequences.tex}

\section{Cohen-Macaulay Rings and Modules}
\input{sections/cohen-macaulay.tex}
\end{document}